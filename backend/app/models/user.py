...
class User(BaseModel):
    ...
    visualizations = relationship(
        "Visualization", back_populates="owner", cascade="all, delete-orphan"
    )
    saved_queries = relationship(
        "SavedQuery", back_populates="owner", cascade="all, delete-orphan"
    )
    ...
    analytics_tasks = relationship(
        "AnalyticsTask", back_populates="owner", cascade="all, delete-orphan"
    )
    ...
    llm_reports = relationship(
        "LLMReport", back_populates="user", cascade="all, delete-orphan"
    )
